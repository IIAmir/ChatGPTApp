...
class ModelsDownWidget extends StatefulWidget {
  const ModelsDownWidget({super.key});

  @override
  State<ModelsDownWidget> createState() => _ModelsDownWidgetState();
}

class _ModelsDownWidgetState extends State<ModelsDownWidget> {
  String? currentModel;
